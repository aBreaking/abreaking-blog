...
public class JHandler extends Handler {
	...
	private void setGlobalAttrs(HttpServletRequest request) {
		...
		//add by liwei
		request.setAttribute(Consts.ATTR_GLOBAL_WEB_DOMAIN, OptionQuery.me().findValue("web_domain"));
		request.setAttribute(Consts.ATTR_GLOBAL_WEB_IP, OptionQuery.me().findValue("web_ip"));
	}
