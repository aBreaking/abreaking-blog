...
import com.abreaking.model.query.MappingQuery;
...
import com.abreaking.template.TplTaxonomyType;
import com.abreaking.freemarker.tag.TaxonomysTag;
...
public class _TaxonomyController extends JBaseCRUDController<Taxonomy> {
	...
	public void save() {
		...
		TaxonomysTag.setTaxonomyRootListNull();
