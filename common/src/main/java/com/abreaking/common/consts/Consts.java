 ...
 */
package com.abreaking.common.consts;
...
public class Consts {
	...
	public static final int ERROR_CODE_COOKIE_NOT_ENABLE = 9;
	...
	//by liwei
	public static final String ATTR_GLOBAL_WEB_DOMAIN = "WEB_DOMAIN";
	public static final String ATTR_GLOBAL_WEB_IP = "WEB_IP";
