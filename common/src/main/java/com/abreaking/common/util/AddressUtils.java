package com.abreaking.common.util;
...
public class AddressUtils {
    ...
    public static String getRegion(String ip){
        ...
        String region = detail.get("region").toString();
        if("XX".indexOf(region)!=-1){
            return "未知";
        }
        return region;
    }
    ...
    public static String getCity(String ip){
        ...
        JSONObject json = JSONObject.parseObject(json_result);
        JSONObject detail = json.getJSONObject("data");
        String city = detail.get("city").toString();
        return city;
    }


    public static String getRegionCity(String ip){
        String json_result = null;
        try {
            json_result = AddressUtils.getAddresses("ip=" + ip, "utf-8");
        } catch (UnsupportedEncodingException e) {
